...
\midrule
Andréa & 5,00 \textit{(Participou)} & 5,00 \textit{(Participou)} & \textit{---} & \textbf{10,00} \\
Arthur Borges & 0,00 \textit{(Não participou)} & 0,00 \textit{(Não participou)} & 0,00 \textit{(Não participou)} & \textbf{0,00} \\
Cristofanis & 0,00 \textit{(Não participou)} & 0,00 \textit{(Não participou)} & \textit{---} & \textbf{0,00} \\
Luiz & 5,00 \textit{(Participou)} & 5,00 \textit{(Participou)} & \textit{---} & \textbf{10,00} \\
Matheus & 5,00 \textit{(Participou)} & 5,00 \textit{(Participou)} & \textit{---} & \textbf{10,00} \\
Yasmin & 5,00 \textit{(Participou)} & 5,00 \textit{(Participou)} & \textit{---} & \textbf{10,00} \\
\bottomrule
\end{tabularx}
