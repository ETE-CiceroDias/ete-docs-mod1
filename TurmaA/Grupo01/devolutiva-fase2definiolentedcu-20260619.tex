...
\midrule
\textbf{Total} & & \textbf{\color{cred}3,75} & \textbf{5,00} \\
\bottomrule
\end{tabular}
...
João Gabriel Cavalcanti & 3,75 \textit{(Participou)} & \textbf{3,75} \\
Suammyr Cavalcante do Carmo & 3,75 \textit{(Liderou)} & \textbf{3,75} \\
Maria Zilda Ferreira Pinto & 3,75 \textit{(Participou)} & \textbf{3,75} \\
