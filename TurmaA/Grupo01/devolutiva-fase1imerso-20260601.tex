...
\begin{itemize}[leftmargin=14pt,itemsep=1pt,topsep=3pt,parsep=0pt]
  ...
  \item[\textcolor{cgood}{$\checkmark$}] {\small\textcolor{cgood}{A seção de PESQUISA PRIMÁRIA apresenta informações relevantes sobre a execução da pesquisa (período de coleta, participantes e contexto)}}
