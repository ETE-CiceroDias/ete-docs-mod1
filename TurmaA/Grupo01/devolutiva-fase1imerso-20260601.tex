...
\begin{itemize}[leftmargin=14pt,itemsep=1pt,topsep=3pt,parsep=0pt]
  ...
  \item[$\square$] {\small\textcolor{cmuted}{A seção de PESQUISA PRIMÁRIA documenta adequadamente os resultados da pesquisa, incluindo principais percepções e evidências coletadas}}
  ...
  \item[$\square$] {\small\textcolor{cmuted}{Uso adequado de terminologia técnica, sem excesso de jargões ou linguagem coloquial}}
