...
% ── METADADOS ────────────────────────────────────────────────
\title{Feedback Avaliativo de Projeto: Projeto Integrador I --- Relatório de Ideação}
...
\midrule
Relatório de Ideação & \statuswarn{Não entregue} & \textbf{0,00} & 1,00 \\
\midrule
\textbf{Total} & & \textbf{\color{cred}0,00} & \textbf{1,00} \\
\bottomrule
\end{tabular}
...
\begin{itemize}[leftmargin=14pt,itemsep=1pt,topsep=3pt,parsep=0pt]
  \item[$\square$] {\small\textcolor{cmuted}{A seção de Ideação está integrada ao documento}}
  \item[$\square$] {\small\textcolor{cmuted}{Inserção dos artefatos de definição no relatório}}
  \item[$\square$] {\small\textcolor{cmuted}{Brainstorm, priorização e solução escolhida estão documentados}}
  \item[$\square$] {\small\textcolor{cmuted}{Descrição do processo de construção do brainstorming}}
...
\toprule
\textbf{Integrante} & \textbf{\small PI Relatório de Ideação} & \textbf{Total} \\
\midrule
