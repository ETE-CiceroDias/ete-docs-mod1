...
\midrule
Persona — Qualidade Visual e Estrutura & \statusok{Completo} & \textbf{2,00} & 2,00 \\
Jornada do Usuário AS TO IS — Qualidade Visual & \statusok{Completo} & \textbf{1,50} & 1,50 \\
Mapa de Empatia — Apresentação Visual & \statusok{Completo} & \textbf{1,50} & 1,50 \\
\midrule
...
\begin{itemize}[leftmargin=14pt,itemsep=1pt,topsep=3pt,parsep=0pt]
  ...
  \item[\textcolor{cgood}{$\checkmark$}] {\small\textcolor{cgood}{(usabilidade) Proficiência tecnológica / letramento digital — quão à vontade a persona está com a tecnologia da solução. Sem isso não dá pra calibrar a complexidade da interface.}}
\end{itemize}
...
\begin{itemize}[leftmargin=14pt,itemsep=1pt,topsep=3pt,parsep=0pt]
  ...
  \item[\textcolor{cgood}{$\checkmark$}] {\small\textcolor{cgood}{Ferramentas/canais que usa HOJE pra lidar com o problema (WhatsApp? ligação? presencial? rádio?)}}
...
\begin{itemize}[leftmargin=14pt,itemsep=1pt,topsep=3pt,parsep=0pt]
  ...
  \item[\textcolor{cgood}{$\checkmark$}] {\small\textcolor{cgood}{Dispositivos e canais reais — que aparelho a persona usa, qual conexão, quais canais ela de fato checa (SMS? WhatsApp? rádio?).}}
...
\midrule
André da Silva Durães & 0,00 \textit{(Não participou)} & 0,00 \textit{(Não participou)} & \textit{---} & \textbf{0,00} \\
Bruna Maria do Nascimento Costa & 0,00 \textit{(Não participou)} & 0,00 \textit{(Não participou)} & \textit{---} & \textbf{0,00} \\
João Gabriel Cavalcanti & 5,00 \textit{(Participou)} & 5,00 \textit{(Participou)} & \textit{---} & \textbf{10,00} \\
Suammyr Cavalcante do Carmo & 5,00 \textit{(Liderou)} & 5,00 \textit{(Liderou)} & \textit{---} & \textbf{10,00} \\
Maria Zilda Ferreira Pinto & 5,00 \textit{(Participou)} & 5,00 \textit{(Participou)} & \textit{---} & \textbf{10,00} \\
Ayran Gabriel Duque Souza Lima & 0,00 \textit{(Não participou)} & 0,00 \textit{(Não participou)} & \textit{---} & \textbf{0,00} \\
\bottomrule
\end{tabularx}
