...
João Gabriel Cavalcanti & 2,00 \textit{(Participou)} & \textbf{2,00} \\
Suammyr Cavalcante do Carmo & 2,00 \textit{(Participou)} & \textbf{2,00} \\
Maria Zilda Ferreira Pinto & 2,00 \textit{(Participou)} & \textbf{2,00} \\
