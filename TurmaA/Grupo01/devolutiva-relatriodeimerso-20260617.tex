...
\midrule
Relatório de Imersão & \statusok{Completo} & \textbf{1,00} & 2,00 \\
\midrule
\textbf{Total} & & \textbf{\color{cred}1,00} & \textbf{2,00} \\
\bottomrule
\end{tabular}
...
\noindent\statusok{1,00\,/\,2,00 pts · Completo}
