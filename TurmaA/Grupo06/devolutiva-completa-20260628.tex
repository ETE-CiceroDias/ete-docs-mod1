...
\midrule
\textbf{Total} & & \textbf{\color{cred}4,18} & \textbf{5,00} \\
\bottomrule
\end{tabular}
...
\midrule
Arthur Leonardo  & 4,18 \textit{(Participou)} & 5,00 \textit{(Participou)} & \textit{---} & \textbf{9,18} \\
Bruno Flaubert & \textit{---} & \textit{---} & \textit{---} & \textbf{0,00} \\
Ewerton Danilo Alves & \textit{---} & \textit{---} & \textit{---} & \textbf{0,00} \\
João Pedro Rodrigues & 4,18 \textit{(Participou)} & 5,00 \textit{(Participou)} & \textit{---} & \textbf{9,18} \\
Thallys Vinícius Lopes da Rocha & 4,18 \textit{(Participou)} & 5,00 \textit{(Participou)} & \textit{---} & \textbf{9,18} \\
Júlia & \textit{---} & \textit{---} & \textit{---} & \textbf{0,00} \\
\bottomrule
\end{tabularx}
